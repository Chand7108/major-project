...
<?php echo Form::open(['route' => 'user.store', 'files' => true, 'id' => 'user-form']); ?>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    <?php echo $__env->make('user.partials.details', ['edit' => false, 'profile' => false], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    <?php echo $__env->make('user.partials.auth', ['edit' => false], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
    </div>
