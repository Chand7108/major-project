...
//Validating Transaction Again
Route::get('valid-transaction-authentication', [
        'as' => 'second_token',
        'uses' => 'SecondTwoFactorController@viewToken'
    ]);

Route::post('valid-transaction-authentication', [
        'as' => 'user.token.validate',
        'uses' => 'SecondTwoFactorController@postToken'
    ]);

//Mandating Two factor authentication
Route::get('two_factor', [
        'as' => 'auth.two_factor',
        'uses' => 'Auth\AuthController@getTwoFactor'
]);


Route::get('second_two_factor', [
        'as' => 'second_two_factor',
        'uses' => 'SecondTwoFactorController@secondTwoFactor'
]);


Route::post('two_factor/enable/{id}', [
        'as' => 'two_factor.enable',
        'uses' => 'Auth\AuthController@enableTwoFactorAuth'
]);
