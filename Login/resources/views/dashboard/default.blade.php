...
<div class="row">
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('vote') }}" class="text-center no-decoration">
                    <div class="icon my-3">
                        <i class="fas fa-user fa-2x"></i>
                    </div>
                    <p class="lead mb-0">@lang('app.vote')</p>
                </a>
            </div>
        </div>
    </div>
    ...
    @if (config('session.driver') == 'database')
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <!-- href="http://localhost:3000/result.html" -->
                    <a  class="text-center  no-decoration" href="http://localhost:3000/result.html" >
                        <div class="icon my-3">
