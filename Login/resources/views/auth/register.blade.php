            ...
            <div class="card-body">
                ...
                <div class="p-4">
                    ...
                    <form role="form" action="<?= url('register') ?>" method="post" id="registration-form" autocomplete="off" class="mt-3">
                        ...
                        <div class="form-group">
                            <input type="voterid" name="voterid" id="voterid" class="form-control" placeholder="@lang('app.voterid')" value="{{ old('voterid') }}" >
                        </div>

                       <!--  <div class="form-group">
                            <input type="text" name="state" id="state" class="form-control" placeholder="@lang('app.state')" value="{{old('state') }}">
                         </div> -->

                        <div class="form-group">
                            <input type="text" name="aadhar_number" id="aadhar_number" class="form-control" placeholder="@lang('app.aadhar')" value="{{ old('aadhar_number')}}"> 
                        </div>
