...
class UsersController extends Controller
{
    ...
    public function store(CreateUserRequest $request)
    {
       ...
       // Create connection
        ...
        // echo $data['aadhar_number'];
        // echo $data['voterid'];
        $sql = "INSERT INTO login_users (email,username,first_name,last_name,password,phone,status,role_id, state, aadhar_number, voterid)
         VALUES ('$data[email]','$data[username]','$data[first_name]','$data[last_name]','$hashedPassword','$data[phone]','$data[status]','$data[role_id]','$data[state]','$data[aadhar_number]','$data[voterid]')";
