...
class AuthController extends Controller
{
    ...
    public function enableTwoFactorAuth($id,EnableTwoFactorRequest $request)
    {
        ...
        return redirect('login')->with('success',trans('app.2fa_enabled'));
...
*/
    ...
    public function postRegister(RegisterRequest $request, RoleRepository $roles)
    {
        ...
        $user = $this->users->create(array_merge(
            $request->only('email','username','voterid','password','aadhar_number','state',),
        ...
        //One option where we need to correct the exception    
        //return redirect('profile/two-factor/enable')->with('success', $message);    
        //return redirect('two_factor')->with('success', $message);
